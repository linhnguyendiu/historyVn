...
// MintCertificate is a paid mutator transaction binding the contract method 0xe7d232a2.
//
// Solidity: function mintCertificate(uint256 newTokenId, address recipient, string name, string course, uint256 date, string cerType, string imageUri) returns(uint256)
func (_CertNFT *CertNFTTransactor) MintCertificate(opts *bind.TransactOpts, newTokenId *big.Int, recipient common.Address, name string, course string, date *big.Int, cerType string, imageUri string) (*types.Transaction, error) {
	return _CertNFT.contract.Transact(opts, "mintCertificate", newTokenId, recipient, name, course, date, cerType, imageUri)
}

// MintCertificate is a paid mutator transaction binding the contract method 0xe7d232a2.
//
// Solidity: function mintCertificate(uint256 newTokenId, address recipient, string name, string course, uint256 date, string cerType, string imageUri) returns(uint256)
func (_CertNFT *CertNFTSession) MintCertificate(newTokenId *big.Int, recipient common.Address, name string, course string, date *big.Int, cerType string, imageUri string) (*types.Transaction, error) {
	return _CertNFT.Contract.MintCertificate(&_CertNFT.TransactOpts, newTokenId, recipient, name, course, date, cerType, imageUri)
}

// MintCertificate is a paid mutator transaction binding the contract method 0xe7d232a2.
//
// Solidity: function mintCertificate(uint256 newTokenId, address recipient, string name, string course, uint256 date, string cerType, string imageUri) returns(uint256)
func (_CertNFT *CertNFTTransactorSession) MintCertificate(newTokenId *big.Int, recipient common.Address, name string, course string, date *big.Int, cerType string, imageUri string) (*types.Transaction, error) {
	return _CertNFT.Contract.MintCertificate(&_CertNFT.TransactOpts, newTokenId, recipient, name, course, date, cerType, imageUri)
}
